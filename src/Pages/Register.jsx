        ...
        <>
            ...
            <Container>
                ...
                <BoxContainer>
                    <Title> SIGN UP </Title>
                    <FormContainer>
                        <Input type="text" onChange={(e) => setPostuser({ ...postuser, name: e.target.value })} placeholder="Full Name" />
                        <Input type="email" onChange={(e) => setPostuser({ ...postuser, email: e.target.value })} placeholder="Email" />
